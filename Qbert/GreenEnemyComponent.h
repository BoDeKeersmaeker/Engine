...
class GreenEnemyComponent final : public engine::Component
{
public:
	GreenEnemyComponent(const std::shared_ptr<engine::GameObject>& owner, const std::weak_ptr<GridNodeComponent>& pStartNode = std::shared_ptr<GridNodeComponent>(nullptr), float moveCooldown = 1.f);
